...
export const prayers = [
  // The prayers list
  {
    ...
    text: 'Om bhur bhuvaḥ swaḥa, tat savitur vareṇyaṃ, bhargo devasya dhīmahi, dhiyo yo naḥ prachodayāt.',
    meaning: 'A prayer to the Sun deity to illuminate our intellect.',
  },
  {
    id: 2,
    title: 'A Simple Morning Prayer',
    text: 'Oh God, lead us from the unreal to the Real. Lead us from darkness to light. Lead us from death to immortality. Om, peace, peace, peace.',
